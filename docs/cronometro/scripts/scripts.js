...
const textMs = document.querySelector('.ms')
...
function formatarTempo(msTotal) {               // msTotal -> total de milisegundos.    // Math.floor (Arredonda pra baixo,REMOVENDO OSDECIMAIS)       
    ...
    let msText = `${String(milisegundos).padStart(3, '0')}ᵐˢ`;
    textMs.innerHTML = msText
...
function restart() {
    ...
    rodando = false
    number = 0
    displayedCount.innerHTML = '00:00'
    textMs.innerHTML = '00<span>ᵐˢ</span>'
